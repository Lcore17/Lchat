...
export default function SearchScreen() {
  ...
  // Place this after searchQuery and performSearch are declared
  ...
  // Listen for socket event to auto-refresh friendship status
  ...
  }, [searchQuery, performSearch, socket]);
      ...
      case 'accepted':
        return (
          <TouchableOpacity
            ...
            onPress={async () => {
              try {
                await apiService.delete(`/friends/remove/${user.id}`);
                setFriendshipStatuses(prev => ({ ...prev, [user.id]: { status: 'none' } }));
                Alert.alert('Unfriended', 'User has been removed from your friends list.');
              } catch (error) {
          ...
          >
            ...
            <Text style={[styles.actionButtonText, { color: 'white' }]}>Unfriend</Text>
          </TouchableOpacity>
        );
      default:
        return null;
